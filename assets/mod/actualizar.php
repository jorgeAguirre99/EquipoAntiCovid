...
//if($today != $row->HOY){
  ...
  $espana = "LOAD DATA INFILE 'E:/Web Design/Web Equipo Anti-Covid/EquipoAntiCovid/media/inc/serie_historica_acumulados.csv' 
  INTO TABLE `covid`
  ...
  $mundo = "LOAD DATA INFILE 'E:/Web Design/Web Equipo Anti-Covid/EquipoAntiCovid/media/inc/total_cases.csv' 
