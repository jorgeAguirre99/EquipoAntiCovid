      ...
      <div class="navbar-collapse collapse order-3 dual-collapse2" style="clear: both; float: right;">
        <ul class="navbar-nav ml-auto" style="display: flex;float: right;clear: both;">
          <li class="nav-item" style="display: flex; align-items: center;">
            <a class="nav-link" style="margin-right: 8px" href="contacto.php">Contacto</a>
          </li>
          <li class="nav-item">
          <a href = "donacion.php"><button class="contribuir btn btn-lg"  type="button">Contribuir</button></a>
          </li>
        </ul>
      </div>
    </nav>
