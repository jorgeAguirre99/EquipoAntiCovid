...
<head>
  ...
  <title>Privacidad | EquipoAntiCovid</title>
  <!--BOOTSTRAP CSS -->
  <script>
 //<![CDATA[
...
<body data-spy="scroll">
 <!--Inicio de la página, está contenida en un page wapper principal-->
<div id="page-wrapper" class="c container-fluid" style="padding: 0;">
        ...
        ?>
        <!--Contenedor 1: Es el contenedor que contiene el efecto parallax, posee en este caso el nombre de la página centrado, se le aplica el efecto de fade in-->
        <div class="img6 parallaxminor mbr-parallax-background c11 container-fluid d-flex align-items-center fadeIn">
            <div class="row">
                <div class="col main"><span class="maintitle">Política de Privacidad</span></div>
            </div>
        </div>
        <!--Contenedor 2: Es el contenedor que contiene el menu para móviles, en response tiene una animación de desplazamiento si son opciones seleccionables, la opción seleccinada esta desplazada más a la derecha-->
        <!--Inicio Contenido de la página-->
        <div class="container">
            <!-- Main -->
            <article id="main">
                <section class="wrapper style5">
                    <div class="inner priv">
                        <h1>Nuestra Política de Privacidad</h1>

                        <p style="text-align: center;">&nbsp;</p>

                        <p>El <strong>equipoanticovid.com(.es)</strong>&nbsp;para proteger los derechos individuales, sobre todo en relación con los tratamientos automatizados y con voluntad de ser transparentes con el Usuario, ha establecido una política que recoge el
                        ...
                        <a href="equipoanticovid@gmail.com">equipoanticovid@gmail.com</a></p>
                        ...
                        <p>Para una mayor información consulte nuestra <a href="politica-cookies.php">política de cookies</a>.</p>
                        ...
                        <p>Salvo que el Usuario se oponga, enviando un email&nbsp;a la dirección de correo electrónico  <a href="equipoanticovid@gmail.com">equipoanticovid@gmail.com</a>, sus datos podrán ser utilizados, en su caso, si procede,
                            para el envío de información comercial de <strong>Equipo Anti Covid</strong></p>
                        ...
                        <p>El Usuario es responsable de que la información que proporcione a través de esta página web sea cierta, respondiendo de la exactitud&nbsp;de todos los datos que comunique y mantendrá actualizada la misma para que reflejen una situación
                            real, siendo responsable de informaciones falsas o inexactas que proporcione y de los daños, molestias y problemas que pudieran causar al Equipo Anti Covid &nbsp;o a terceros.</p>
                        ...
                        <p>Equipo Anti Covid declina, cualquier tipo de responsabilidad&nbsp;sobre las consecuencias de esos&nbsp;actos puedan tener para el Usuario, si publicó la información voluntariamente.</p>

                        <p>Podrá acceder y ejercitar esos derechos mediante solicitud por escrito&nbsp;y firmada que podrá ser enviada al siguiente correo electrónico: <a href="equipoanticovid@gmail.com">equipoanticovid@gmail.com</a> adjuntando fotocopia del
